...
silver_winners_tex = (
    ...
    ("%1857>%", "%1857>%\n\\pagebreak", 1),
    # -----------------------------------------------------------------
    # 1994 /1 [shrink adding negative space, add a line to bottom]
    ("\n%1858>%", "\\vspace{-2pt}\n%1858>%", 1),
    ("\n%1859>%", "\\vspace{-2pt}\n%1859>%", 1),
    ("\n%1860>%", "\\vspace{-10pt}\n%1860>%", 1),
    ("\n%530>%", "\\vspace{-2pt}\n%530>%", 1),
    ...
    # -----------------------------------------------------------------
    # 2013 /1 [shrink adding negative space] 
    ("%1277>%", "\\vspace{-2pt}\n%1277>%", 1),
    ("%1280>%", "\\vspace{-2pt}\n%1280>%", 1),
    ("%1283>%", "\\vspace{-2pt}\n%1283>%", 1),
    ("%2175>%", "\\vspace{-2pt}\n%2175>%", 1),
    ...
    # 2015 /2 -> looks good
    # -----------------------------------------------------------------
    # 2015 /3 [shrink adding negative space]
    ("%1384>%", "\\vspace{-2pt}\n%1384>%", 1),
    ("%1386>%", "\\vspace{-2pt}\n%1386>%", 1),
    ("%1387>%", "\\vspace{-2pt}\n%1387>%", 1),
    ("%1388>%", "\\vspace{-2pt}\n%1388>%", 1),
    ...
    # 2016 /2 -> looks good
    # -----------------------------------------------------------------
    # 2017 -> [shrink adding negative space, add a line to bottom]
    ("%1421>%", "\\vspace{-4pt}\n%1421>%", 1),
    ("%1422>%", "\\vspace{-2pt}\n%1422>%", 1),
    ("%1424>%", "\\vspace{-2pt}\n%1424>%", 1),
    ("%1425>%", "\\vspace{-2pt}\n%1425>%", 1),
    ...
    ("%1430>%", "%1430>%\n\\enlargethispage{1\\baselineskip}", 1),
    # -----------------------------------------------------------------
    # 2018 -> [shrink adding negative space, add a line to bottom]
    ("%1432>%", "\\vspace{-2pt}\n%1432>%", 1), 
    ("%1434>%", "\\vspace{-2pt}\n%1434>%", 1), 
    ("%1435>%", "\\vspace{-10pt}\n%1435>%", 1), 
    ("%1437>%", "\\vspace{-2pt}\n%1437>%", 1), 
    ...
    ("%2132>%", "%2132>%\n\\pagebreak", 1),
    # -----------------------------------------------------------------
    # 2024 /1 [shrink adding negative space, add a line to bottom]
    ("\n%2142>%", "\\vspace{-2pt}\n%2142>%", 1),
    ("\n%2151>%", "\\vspace{-2pt}\n%2151>%", 1),
    ("\n%2173>%", "\\vspace{-2pt}\n%2173>%", 1),
    ("\n%2152>%", "\\vspace{-2pt}\n%2152>%", 1),
    ...
    ("%<2179%\n", "%<2179%\n\\enlargethispage{1\\baselineskip}", 1),
    # -----------------------------------------------------------------
    # 2024 /2 [shrink adding negative space, add a line to bottom]
    ("\n%2184>%", "\\vspace{-2pt}\n%2184>%", 1),
    ("\n%2198>%", "\\vspace{-2pt}\n%2198>%", 1),
    ("\n%2205>%", "\\vspace{-2pt}\n%2205>%", 1),
    ("\n%2206>%", "\\vspace{-2pt}\n%2206>%", 1),
