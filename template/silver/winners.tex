...
{% macro get_mention(w) -%}
{%- if w.or_title=="_null" -%} {{- get_acro_for_mentions(w) -}}, {{ w.country_abbr -}}
{%- else -%}
{{ get_title_for_mentions(w.lang_title, w.or_title, w.en_title) }} by {{ get_acro_for_mentions(w) -}}, {{ w.country_abbr -}}
{% endif -%}
