...
\textsl{In this book we have followed the rule of indicating as ``also mentioned'' those programmes that were only reported in the jury report, but of which we could not find any official publication.}
